			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<?php if (isset($_SESSION["order_confirm"])) {
  echo '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close">×</a><b>'.$_SESSION["order_confirm"].'!</b></div>';
  $_SESSION["order_confirm"]=null;
} ?>
