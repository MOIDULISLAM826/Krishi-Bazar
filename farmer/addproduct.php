...
mysqli_query($con,"insert into products (product_owner,product_cat, product_brand,product_title,product_price,product_stock, product_desc, product_image,product_keywords) values ('$user_id','$product_type','$brand','$product_name','$price','$quantity','$details','$pic_name','$tags')") or die ("query incorrect");
