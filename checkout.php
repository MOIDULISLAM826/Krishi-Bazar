	...
	<div class="container-fluid">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="phone"><i class="fa fa-phone"></i> Phone No</label>
						<input type="text" id="phone" name="phone" class="form-control" value="'.$row["mobile"].'" required>
					...
					for($ii=0;$ii<$total_n;$ii++){						
						echo "
						<input type='hidden' name='product_title[]' value='$product_title[$ii]'>
						<input type='hidden' name='product_id[]' value='$product_id[$ii]'>
						<input type='hidden' name='t_price[]' value='$total_price[$ii]'>
						<input type='hidden' name='qty[]' value='$qty[$ii]'>
						";						
					}
		...
		?>
			...
			<div class="col-25">
				...
				$grand_total= $grand_total + $total_price[$ii];			
						
						$sl = $ii+1;
						echo "<tr><td><p>$sl</p></td><td><p>$product_title[$ii]</p></td><td ><p>$qty[$ii]</p></td><td ><p>$total_price[$ii]</p></td></tr>";
				...
				<h3>Total<span class='price' style='color:black'><b>RM $grand_total</b></span></h3>";
