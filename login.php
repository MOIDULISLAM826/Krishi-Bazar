			...
			$BackToMyPage = $_SERVER['HTTP_REFERER'];
				if(!isset($BackToMyPage)) {
					...
					switch($utype){
						...
						case 1: echo '<script type="text/javascript">window.location.href="admin/index.php";;</script>';
						break;
						
						
						case 2: echo '<script type="text/javascript">window.location.href="farmer/index.php";;</script>';
						break;
						
						case 3: echo '<script type="text/javascript">window.location.href="store.php";;</script>';
						break;
						
						default: echo '<script type="text/javascript">window.location.href="index.php";;</script>';
					}
