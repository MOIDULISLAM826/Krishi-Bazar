			...
			echo "
                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									if($pro_stock==0)
									{
										echo "<button class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i>Out of stock</button>";
									}else{
										echo "<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> add to cart</button>";
									}
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_stock,a.product_id,a.product_title,a.product_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
	}else{
		//When user is not logged in this query will execute
		$sql = "SELECT a.product_stock,a.product_id,a.product_title,a.product_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
	}
	$query = mysqli_query($con,$sql);
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>We are here for provide you Fresh food. All of our fruits are fresh and also price is less than any other place.</p>
										</div>
									</div>
							...
							<td data-th="Price"><input name="product_price[]" type="text" class="form-control price" value="'.$product_price.'" readonly="readonly"></td>
							<td data-th="Quantity">
								<input type="number" max="" onchange="validateQuantity(this,'.$product_stock.');" name="qty[]" class="form-control qty" value="'.$qty.'" >
							</td>
							<td data-th="Subtotal" class="text-center"><input name="total_price[]" type="text" class="form-control total" value="'.$product_price.'" readonly="readonly"></td>
